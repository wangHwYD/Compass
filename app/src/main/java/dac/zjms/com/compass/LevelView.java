...
public class LevelView extends View {
    ...
    //水平2级
    private int mHorizontalColorTWO;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mHorizontalColorTWO = a.getColor(R.styleable.LevelView_horizontalColor_two, mHorizontalColorTWO);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int bubbleColor;
        if (isCenter){
            bubbleColor = mHorizontalColor;
            //水平时振动
            vibrator.vibrate(10);

        }else {
            boolean center21 = isCenter2(bubblePoint);
           // int bubbleColorTwo = center21 ? mHorizontalColorTWO : mBubbleColor;
            if (center21){
                bubbleColor =   mHorizontalColorTWO ;
            }else {
    ...
    private boolean isCenter(PointF bubblePoint){
       ...
       // return Math.abs(bubblePoint.x - centerPnt.x) < 1 && Math.abs(bubblePoint.y - centerPnt.y) < 1;
        return Math.abs(bubblePoint.x - centerPnt.x) < 15 && Math.abs(bubblePoint.y - centerPnt.y) < 15;
    }
    private boolean isCenter2(PointF bubblePoint){
        ...
        // return Math.abs(bubblePoint.x - centerPnt.x) < 1 && Math.abs(bubblePoint.y - centerPnt.y) < 1;
        return Math.abs(bubblePoint.x - centerPnt.x) < 50 && Math.abs(bubblePoint.y - centerPnt.y) < 50;
    }
